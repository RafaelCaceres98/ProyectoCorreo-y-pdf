...
namespace DAL
{
    public class ClienteRepository
    {
        ...
        public void Guardar(Cliente cliente) {
            ...
            using (OracleCommand command = new OracleCommand("GuardarCliente", connection._conexion))
            {
                ...
                command.Parameters.Add("Email", OracleDbType.Varchar2).Value = cliente.Email.Address;
